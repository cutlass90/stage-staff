...
from main import StageGenerator
...
def main():
    ...
    controlnet_conditioning_scale = st.number_input('controlnet_conditioning_scale', min_value=0.0, max_value=1.0, value=0.5, step=0.01)
